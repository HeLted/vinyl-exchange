    ...
    public class ReleaseFilesSeeder : ISeeder
    {
        ...
        public async Task SeedAsync(VinylExchangeDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            if (!dbContext.ReleaseFiles.Any())
            {
                ...
                await SeedReleaseFileAsync(dbContext, Guid.Parse("3cc8ee5c-4dc3-4009-b3fc-d768e6a564f8"), FileType.Audio,
             "863aad8d-a80a-453d-b9c8-010e4d84c564@---@QXBoZXggVHdpbiAtIFh0YWw=.mp3", false);

                //De Lacy - Hideaway
                await SeedReleaseFileAsync(dbContext, Guid.Parse("1cf99ed0-a565-4d2a-928b-99a0fd851d9b"), FileType.Image,
                  "0002affb-a428-4279-bfc0-5202a1558850@---@Ui00MzgwMS0xMjM5MDM4Nzg2LmpwZWc=.jpg", true);

                await SeedReleaseFileAsync(dbContext, Guid.Parse("1cf99ed0-a565-4d2a-928b-99a0fd851d9b"), FileType.Audio,
