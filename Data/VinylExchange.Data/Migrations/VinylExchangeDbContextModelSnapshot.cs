...
#pragma warning disable 612, 618
            modelBuilder.HasAnnotation("ProductVersion", "3.1.1").HasAnnotation("Relational:MaxIdentifierLength", 128)
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.Property<string>("UserCode").HasColumnType("nvarchar(200)").HasMaxLength(200);

                        b.Property<string>("ClientId").IsRequired().HasColumnType("nvarchar(200)").HasMaxLength(200);

                        b.Property<DateTime>("CreationTime").HasColumnType("datetime2");

                        b.Property<string>("Data").IsRequired().HasColumnType("nvarchar(max)").HasMaxLength(50000);

                        b.Property<string>("DeviceCode").IsRequired().HasColumnType("nvarchar(200)").HasMaxLength(200);

                        b.Property<DateTime?>("Expiration").IsRequired().HasColumnType("datetime2");

                        b.Property<string>("SubjectId").HasColumnType("nvarchar(200)").HasMaxLength(200);
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.Property<string>("Key").HasColumnType("nvarchar(200)").HasMaxLength(200);
                        ...
                        b.Property<string>("Type").IsRequired().HasColumnType("nvarchar(50)").HasMaxLength(50);
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int").HasAnnotation(
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.Address",
                b =>
                    {
                        b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");

                        b.Property<string>("Country").IsRequired().HasColumnType("nvarchar(40)").HasMaxLength(40);

                        b.Property<string>("FullAddress").IsRequired().HasColumnType("nvarchar(300)").HasMaxLength(300);

                        b.Property<string>("PostalCode").IsRequired().HasColumnType("nvarchar(40)").HasMaxLength(40);
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.CollectionItem",
                b =>
                    {
                        b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
                        ...
                        b.Property<int>("SleeveGrade").HasColumnType("int");

                        b.Property<Guid>("UserId").HasColumnType("uniqueidentifier");

                        b.Property<int>("VinylGrade").HasColumnType("int");
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.Genre",
                b =>
                    {
                        b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int").HasAnnotation(
                            "SqlServer:ValueGenerationStrategy",
                ...
                b =>
                    {
                        ...
                        b.Property<string>("Year").IsRequired().HasColumnType("nvarchar(max)");
                ...
                b =>
                    {
                        ...
                        b.Property<bool>("IsPreview").HasColumnType("bit");
                ...
                b =>
                    {
                        ...
                        b.Property<string>("OrderId").HasColumnType("nvarchar(max)");

                        b.Property<decimal>("Price").HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.Style",
                b =>
                    {
                        b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int").HasAnnotation(
                            "SqlServer:ValueGenerationStrategy",
                        ...
                        b.Property<int>("GenreId").HasColumnType("int");
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.StyleRelease",
                b =>
                    {
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.VinylExchangeRole",
                b =>
                    {
                        b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity(
                "VinylExchange.Data.Models.VinylExchangeUser",
                b =>
                    {
                        b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
                        ...
                        b.Property<byte[]>("Avatar").IsRequired().HasColumnType("varbinary(max)")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.VinylExchangeRole", null).WithMany().HasForeignKey("RoleId")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.VinylExchangeUser", null).WithMany().HasForeignKey("UserId")
                            .OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.VinylExchangeUser", "User").WithMany("Addresses")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.Release", "Release").WithMany("ReleaseCollections")
                            .HasForeignKey("ReleaseId").OnDelete(DeleteBehavior.Cascade).IsRequired();

                        b.HasOne("VinylExchange.Data.Models.VinylExchangeUser", "User").WithMany("Collection")
                            .HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.Release", "Release").WithMany("ReleaseFiles")
                            .HasForeignKey("ReleaseId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.VinylExchangeUser", "Buyer").WithMany("Purchases")
                            .HasForeignKey("BuyerId").OnDelete(DeleteBehavior.Restrict);

                        b.HasOne("VinylExchange.Data.Models.Release", "Release").WithMany("Sales")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.Sale", "Sale").WithMany("Messages").HasForeignKey("SaleId")
                            .OnDelete(DeleteBehavior.Cascade).IsRequired();

                        b.HasOne("VinylExchange.Data.Models.VinylExchangeUser", "User").WithMany("Messages")
                            .HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.Genre", "Genre").WithMany("Styles").HasForeignKey("GenreId")
                            .OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("VinylExchange.Data.Models.Release", "Release").WithMany("Styles")
                            .HasForeignKey("ReleaseId").OnDelete(DeleteBehavior.Cascade).IsRequired();

                        b.HasOne("VinylExchange.Data.Models.Style", "Style").WithMany("Releases")
                            .HasForeignKey("StyleId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    });
