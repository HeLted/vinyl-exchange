  ...
  render() {
    ...
    return (
      <div className="player-on-top sm2-bar-ui full-width fixed">
        <div className="custom-player-controls bd sm2-main-controls">
          ...
          <div className="sm2-inline-element sm2-button-element">
            <div className="sm2-button-bd">
              <a href="#play" className="sm2-inline-button sm2-icon-play-pause">
                Play / pause
              </a>
            </div>
          </div>
              ...
              <div className="sm2-row">
                ...
                <div className="sm2-progress-bd">
                  <div className="sm2-progress-track">
                    ...
                    <div className="sm2-progress-ball">
        ...
        <div className={className + " custom-playlist-wrapper sm2-playlist-wrapper"}>
          <ul className="sm2-playlist-bd">
            ...
            <li>
              <a href="http://freshly-ground.com/data/audio/sm2/SonReal%20-%20Let%20Me%20%28Prod%202oolman%29.mp3">
                <b>SonReal</b> - Let Me <span className="label">Explicit</span>
              </a>
            </li>
            <li>
