namespace VinylExchange.Common.Constants
{
    ...
    {
        public const string InvalidMinLength = "Invalid min length of field!";
        ...
        public const string PassAndConfrimPassNotMatching = "The password and confirmation password do not match";

        public const string SelectCorrectEnumOption = "Please select correct option for field";
    }
}